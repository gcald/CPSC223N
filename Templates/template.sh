...
echo Compile TemplateLogic.cs to create the file: TemplateLogic.dll
mcs -t:library TemplateLogic.cs -r:System.Windows.Forms.dll -out:TemplateLogic.dll

echo Compile TemplateFrame.cs to create the file: TemplateFrame.dll
mcs -t:library TemplateFrame.cs -r:System.Drawing -r:System.Windows.Forms.dll -r:TemplateLogic.dll -out:TemplateFrame.dll

echo Compile TemplateMain.cs and link the previously created dll file to create an executable file. 
mcs -t:exe TemplateMain.cs -r:System.Windows.Forms.dll -r:TemplateFrame.dll -out:Template.exe
